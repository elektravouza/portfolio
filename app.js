...
const projects = [
    { 
        ...
        description: "This is a detailed description for Entropia project. Expand this text as much as you like.",
        media: ["./assets/entropia.jpg", "./assets/where.avif", "./assets/femina.avif"] // Πρόσθεσε εδώ τα media σου
    },
    { 
        id: "02", 
        title: "Where", 
        ...
        description: "Exploration of spatial and digital presence. Visual presentation and case studies.",
        media: ["./assets/where.avif", "./assets/entropia.jpg"]
    },
    { 
        id: "03", 
        ...
        description: "UI/UX interface and interactive design developed collaboratively with Vestart.",
        media: ["./assets/social.mp4", "./assets/game.avif"]
    },
...
// ΛΕΙΤΟΥΡΓΙΑ ΠΡΟΒΟΛΗΣ PROJECT (DYNAMIC SLIDER LAYOUT)
...
function openProject(index) {
    ...
    document.getElementById('p-desc').innerText = project.description || "Project details and visual documentation.";
    
    const mediaContainer = document.getElementById('p-media');
    mediaContainer.innerHTML = ''; 
    
    // Αν δεν έχει οριστεί λίστα 'media', δείχνει την κεντρική εικόνα
    const mediaList = project.media || [project.img]; 
...
function startEasterEgg() { console.log("Easter egg activated!"); }